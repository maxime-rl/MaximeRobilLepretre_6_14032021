...
/* harmony import */ var _styles_main_scss__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../styles/main.scss */ "./src/styles/main.scss");
...
function createPhotographersList(data) {
  ...
  photographers.forEach(function (elt) {
    var photographerDOM = document.createElement("li");
    photographerDOM.classList.add("photographer");
    photographerDOM.innerHTML = "\n    <a>\n      <p>".concat(elt.id, "</p>\n    </a>\n    ");
    return photographerDOM;
  });
  photographersList.innerHTML = "";
  photographersList.append.apply(photographersList, _toConsumableArray(photographers));
}

function test(data) {
  var user = data.photographers;
  Object.keys(user).map(function (elt) {
    console.log(elt);
    return elt;
  });
}
