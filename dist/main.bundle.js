...
var Photographer = /*#__PURE__*/function () {
  ...
  _createClass(Photographer, [{
    ...
    value: function createMainDomElements() {
      var photographersList = document.querySelector(".photographers-list");
      var ulElPhotographer = document.createElement("ul");
      var liElPhotographer = (0,_createElementFactory_js__WEBPACK_IMPORTED_MODULE_3__.createElementFactory)("li", {
        class: "photographer"
      });
      var aELPhotographer = (0,_createElementFactory_js__WEBPACK_IMPORTED_MODULE_3__.createElementFactory)("a", {
        href: "photographer.html?id=".concat(this.id),
        tabindex: "0"
      });
      var spanElPhotographer = (0,_createElementFactory_js__WEBPACK_IMPORTED_MODULE_3__.createElementFactory)("span", {
      ...
      var pElPhotographerLocation = (0,_createElementFactory_js__WEBPACK_IMPORTED_MODULE_3__.createElementFactory)("p", {
        class: "photographer__location"
      }, "".concat(this.city, ", ").concat(this.country));
      var pElPhotographerTagline = (0,_createElementFactory_js__WEBPACK_IMPORTED_MODULE_3__.createElementFactory)("p", {
        class: "photographer__tagline"
      }, "".concat(this.tagline));
      var pElPhotographerPrice = (0,_createElementFactory_js__WEBPACK_IMPORTED_MODULE_3__.createElementFactory)("p", {
    ...
    key: "createProfilHeaderDomElements",
    value: function createProfilHeaderDomElements() {
      ...
      var btnElPhotographer = (0,_createElementFactory_js__WEBPACK_IMPORTED_MODULE_3__.createElementFactory)("button", {
        type: "button",
        class: "btn",
...
var filterTagsList = document.querySelector(".nav-tags-list");
/**
...
var createFilterTagsNavList = function createFilterTagsNavList(data) {
  collectSortedTags(data).forEach(function (tag) {
    var liEl = (0,_createElementFactory_js__WEBPACK_IMPORTED_MODULE_15__.createElementFactory)("li");
    var aEl = (0,_createElementFactory_js__WEBPACK_IMPORTED_MODULE_15__.createElementFactory)("a", {
      href: "#",
      class: "tag",
      "data-filter": "".concat(tag)
    });
    var spanEl = (0,_createElementFactory_js__WEBPACK_IMPORTED_MODULE_15__.createElementFactory)("span", {
      class: "sr-only"
    }, "tag");
    aEl.textContent = "#" + tag;
  ...
  var liAllEl = (0,_createElementFactory_js__WEBPACK_IMPORTED_MODULE_15__.createElementFactory)("li");
  var aAllEl = (0,_createElementFactory_js__WEBPACK_IMPORTED_MODULE_15__.createElementFactory)("a", {
    href: "#",
    class: "tag tag--active",
    "data-filter": "all"
  }, "#all");
  var spanAllEl = (0,_createElementFactory_js__WEBPACK_IMPORTED_MODULE_15__.createElementFactory)("span", {
    class: "sr-only"
  }, "tag");
...
var filteringPhotographersByTags = function filteringPhotographersByTags(data) {
  ...
  var photographerCard = photographersList.getElementsByClassName("photographer");
  ...
  try {
    for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
      ...
      tag.addEventListener("click", function (e) {
        ...
        el.classList.add("tag--active"); // storage data attribute filter on click on each tag

        var dataSetFilterTagNav = el.dataset.filter; // compare data attribute filter in tags of each photographer and show or hide photographer
        ...
        if (dataSetFilterTagNav === "all") {
          var _iterator4 = _createForOfIteratorHelper(photographersList.children),
              _step4;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "createPhotographerProfilPage": () => (/* binding */ createPhotographerProfilPage)
/* harmony export */ });
...
/* harmony import */ var _Photographer_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./Photographer.js */ "./src/js/Photographer.js");
...
var createPhotographerProfilPage = function createPhotographerProfilPage(data) {
  var photographerHeader = "";
  data.photographers.forEach(function (photographer) {
    if (photographer.id === Number(urlParams.get("id"))) {
      photographerHeader = new _Photographer_js__WEBPACK_IMPORTED_MODULE_11__.Photographer(photographer.id, photographer.name, photographer.portrait, photographer.city, photographer.country, photographer.tags, photographer.tagline, photographer.price).createProfilHeaderDomElements();
    }
  });
